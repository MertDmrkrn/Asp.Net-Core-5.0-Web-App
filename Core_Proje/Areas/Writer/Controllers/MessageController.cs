...
namespace Core_Proje.Areas.Writer.Controllers
{
    ...
    public class MessageController : Controller
    {
        ...
        [Route("")]//çift tırnak içerisine parametre yazmadık çünkü ReceiverMessage Viewinde listeleme işlemi yapmak istiyoruz bu işlemle
        [Route("ReceiverMessage")]//yönlendirmek istediğimiz yeri yazdık
        ...
        [Route("MessageDetails/{id}")]//dışarıdan almış olduğun id ile MessageDetails'a git
